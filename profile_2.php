...
<form action="profile_2.php?username=<?php echo $username; ?>" method="post">
        <?php
        if ($userid != $followerid) {
                if ($isFollowing) {
...
<form action="profile_2.php?username=<?php echo $username; ?>" method="post" enctype="multipart/form-data">
